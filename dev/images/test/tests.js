...
var aPhoto = { name: 'SomePhoto', image: 'photos/lake.jpg' };
console.log('[exif] Starting exif tests'.yellow);
var obj = new exif.ExifImage(aPhoto, function(err, photo){
 ...
 */
var galleryParams = {static: './', directory: '/photos', name: 'Test Gallery'};
